...
const SidebarCart = ({ isOpen, toggleSidebar }) => {
  ...
  const handleIncreaseQuantity = (id) => {
    fetch(
      `https://api.theoutmaker.com/api/user/product/add_to/cart/${userCode}/${id}`,
      {
        method: "POST",
        headers: {
  ...
  const handleDecreaseQuantity = (id) => {
    fetch(
      `https://api.theoutmaker.com/api/user/product/delete_from/cart/${userCode}/${id}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const delete_product_from_cart = (id) => {
    fetch(
      `https://api.theoutmaker.com/api/user/product/delete_product_from_cart/cart/${userCode}/${id}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
