...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://api.theoutmaker.com.au/api/get/frontend/category-blogs/${params.id}`
          ),
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://api.theoutmaker.com.au/api/get/frontend/single-post/details/${params.id}`
          ),
      },
      {
        ...
        element: <Product />,
        loader: ({ params }) =>
          fetch(`https://api.theoutmaker.com.au/api/get/category/single/${params.id}`),
      },
      {
...

      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://api.theoutmaker.com.au/api/get/collection/single/${params.id}`
          ),
      },
      {
        ...
        loader: ({ params }) =>
          fetch(`https://api.theoutmaker.com.au/api/get/product/single/${params.id}`),
      },
      {
        path: "/contact",
        element: <Contact />,
