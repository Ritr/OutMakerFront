       ...
       <div>
        ...
        <section className='container bg-sky-100 p-10 rounded-lg' >
            ...
            <div className='leading-10'>
                <p>Current Order Status: <span className='text-blue-900'>The buyer has paid and is waiting for the seller to ship</span></p>
                1. Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, fugit!
                <br />
                2. Add Note
            </div>
        ...
        <section className='bg-gray py-10'>
            <button className='bg-blue-900 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded-full'>Order Information</button>
            <div className="order_info flex justify-between py-5 px-20">
                <div className='good_Receving_information leading-8'>
                    <h3 className='text-blue-900 font-bold'>Goods receiving Information</h3>
